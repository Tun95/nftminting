...
// FORMAT CURRENCY NUMBER With no Decimal
export const formatNairaNoDecimalShort = (value: number): string => {
  ...
  // Use Math.floor to remove decimal places and add the Naira symbol
  return `₦${Math.floor(value)}${suffixes[suffixIndex]}`;
};
